...
import { Home, Compass, BookOpen, Users, User, Flame, Trophy } from "lucide-react";
...
export default function GlassNavbar({ currentPage, onNavigate, gameData }: GlassNavbarProps) {
  const navItems = [
    { id: 'dashboard', icon: Home, label: 'Base', color: 'text-blue-400' },
    { id: 'explorer', icon: Compass, label: 'Explore', color: 'text-purple-400' },
    { id: 'learning', icon: BookOpen, label: 'Knowledge', color: 'text-green-400' },
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="text-white/90 font-semibold text-xl">Career Cosmos</span>
          </div>
          ...
          <div className="flex items-center space-x-3">
            <div className="bg-orange-500/30 backdrop-blur-xl border border-orange-400/30 rounded-full px-3 py-1 flex items-center space-x-2">
              ...
              <span className="text-sm font-medium text-orange-300">{gameData.streak}</span>
            </div>
            ...
            <div className="bg-purple-500/30 backdrop-blur-xl border border-purple-400/30 rounded-full px-3 py-1 flex items-center space-x-2">
              ...
              <span className="text-sm font-medium text-purple-300">L{gameData.level}</span>
            </div>
          </div>
        </div>
      </div>
